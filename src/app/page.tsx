...
const PACKS = [
  {
    ...
    agents: [
      { name: "Nova", role: "Content Strategist", emoji: "✨" },
      { name: "Quill", role: "Script Writer", emoji: "🖋️" },
      { name: "Echo", role: "Social Amplifier", emoji: "📣" },
    ],
  ...
  },
  {
    ...
    agents: [
      { name: "Forge", role: "Tech Lead", emoji: "⚡" },
      { name: "Hawk", role: "Code Reviewer", emoji: "🦅" },
      { name: "Scribe", role: "Doc Master", emoji: "📜" },
    ],
  ...
  },
  {
    ...
    agents: [
      { name: "Atlas", role: "Chief of Staff", emoji: "🗺️" },
      { name: "Sage", role: "Research Wizard", emoji: "🔮" },
      { name: "Pulse", role: "Outreach Pro", emoji: "💫" },
    ],
